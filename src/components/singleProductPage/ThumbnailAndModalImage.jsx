...
const ThumbnailAndModalImage = ({product}) => {
    ...
    const productVideoLength = product.productVideo.filter(a=> a.video != "").length;
        ...
        <div className="max-h-[80vh] max-w-[1024px] w-full h-full rounded-lg bg-white z-20 flex flex-col">
          ...
          <div className="flex flex-row w-full h-full  ">
            <div className=" w-3/5 bg-white h-full border border-r-0 border-b-0 border-t-0 modalSlideShow">
              ...
              >
                {productVideoLength > 0 && product.productVideo.map((video, index) => {
                  return (
                    <SwiperSlide>
{video.video && (
...
<source className="w-full  bg-white"  src={video.video} />
            ...
            <div className="w-2/5 flex overflow-y-scroll scrollCustomer flex-col h-full bg-white px-4 py-4">
              ...
              <div className="flex flex-wrap w-full">
                {productVideoLength > 0 && product.productVideo.map((image, index) => {
                    return (
                    <div
                      onClick={() =>
