...
const Navbar = ({ mainCategory, category }) => {
  ...
  return (
    <div className="xl:border xl:border-t-0 xl:border-l-0 xl:border-r-0 mt-0 !h-auto w-full mb-0 xl:mb-[107px] z-50">
      ...
      <div className={` w-full h-auto z-[9] xl:hidden bg-white border-2 border-x-0 border-t-0 transition-300 duration-1000 `}>
        <div
            ...
            {hoverSubMenu ? (
                <>
                  {category
                    .filter(
                      (category) =>
                        category.mainCategory == firstMainCategoryName
                    )
                    .map((category) => {
                      return (
                        <>
