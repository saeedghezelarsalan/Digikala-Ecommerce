          ...
          return (
            <SwiperSlide>
                    <Link href={`/product/${offerProduct.slug}`}>
                      <a>
                        <div className="bg-white h-full flex flex-col justify-between px-2 cursor-pointer">
                          <Image
                          ...
                          <div className="flex flex-col gap-y-1 items-end mb-1">
                            <div className="w-full mt-3 flex flex-wrap items-center justify-between">
                              ...
                              <div className="flex flex-wrap items-center">
                                <span className="text-sm lg:text-base text-[#424750] font-bold">{Number(offerProduct.price).toLocaleString("fa-IR")}</span>

                               <span className="text-[8px] text-[#424750] font-bold mr-1">تومان</span>
                              </div>
                            </div>
                            <div>
                              <del
          ...
          <Link href="/">
            <a>
              <div className="h-full text-center text-lg bg-white rounded-tl-lg rounded-bl-lg w-full flex flex-col justify-center items-center cursor-pointer">
                ...
                <span className="text-xs lg:text-sm text-[#424750]">مشاهده همه</span>
              </div>
            </a>
          </Link>
        </SwiperSlide>
