        ...
        <div className="flex justify-center max-w-screen-2xl w-full lg:mx-24 py-12 lg:gap-x-4">
          ...
          {cartBasketLength > 0 ? (
            <>
              ...
              >
                <div
                  className=" w-full lg:px-5 px-2 sm:px-12 h-auto  fixed bottom-0 right-0 lg:relative  flex flex-row-reverse justify-between items-center bg-white py-2 z-40 border border-l-0 border-r-0 border-b-0 border-gray-200 lg:flex-col lg:flex lg:items-end lg:w-full  lg:border-0 lg:gap-y-3 lg:py-3">
