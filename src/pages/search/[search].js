        ...
        <div className="w-full flex flex-col lg:flex-row px-3">
          ...
          <div className="w-[300px] border hidden flex-col lg:flex px-2 py-4">
            <div className="flex flex-col">
              ...
              {/* فیلتر اصلی */}
              {filterProducts && filterProducts.map(filter => {
                return (
          ...
          <div className="flex lg:hidden items-center mx-10 border border-x-0 border-t-0 pb-2">
...
export async function getServerSideProps({ params }) {
  ...
  let productss = data.map(a => a).filter((product) => product.subCategory == query ? product.subCategory == query : product.category == query ? product.category == query : null);
