...
const ProductPrice = ({product,setQuantityReduxProduct,quantityReduxProduct}:any) => {
  ...
  <div
    ...
    <div className={`productPriceBg w-full lg:px-5 px-2 sm:px-12 h-auto bottom-0 fixed lg:relative justify-between items-center bg-white py-2 z-[99] lg:z-0 border-2 lg:border-0 border-l-0 border-r-0 border-b-0  border-gray-200 lg:flex-col-reverse lg:flex lg:items-end lg:w-full lg:gap-y-3 lg:py-3 flex`}>
